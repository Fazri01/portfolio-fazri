    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sample_form').on('submit', function(event) {
                ...
                if ($('#action').val() == "Add") {
                    ...
                    $.ajax({
                        url: "https://fazrisidiq1.amisbudi.cloud/portfolio-fazri/si-admin/api/skills/create.php",
                        method: "POST",
                    ...
                    $.ajax({
                        url: "https://fazrisidiq1.amisbudi.cloud/portfolio-fazri/si-admin/api/skills/update.php",
                        method: "PUT",
                        data: JSON.stringify(formData),
                        success: function(data) {
                            $('#action_button').attr('disabled', false);
        ...
        function showAll() {
            $.ajax({
                ...
                url: "https://fazrisidiq1.amisbudi.cloud/portfolio-fazri/si-admin/api/skills/read.php",
